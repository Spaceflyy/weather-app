...
const getWeatherData = async (location) => {
	try {
		...
		for (let i = 0; i < dayForecasts.length; i++) {
			...
			p.innerText = `${weekDay[(0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(dayForecasts[i].date))]} ${
